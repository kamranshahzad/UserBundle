...
class EmployeeEmailType extends AbstractType
{
    ...
    {
        $emailTypes = array('p' => 'Personal', 'o' => 'Official');

        $defaultOptions = array('multiple'=>false,'expanded'=>true , 'choice_list' => new SimpleChoiceList($emailTypes));
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Kamran\UserBundle\Entity\EmployeeEmail'
        ));
    }
